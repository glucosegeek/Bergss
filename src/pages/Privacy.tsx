    ...
    <div className="container mx-auto px-4 py-24">
      ...
      <div className="prose prose-invert max-w-none">
        <p className="text-blue-100/80 text-lg">
          Niniejszy dokument ma zastosowanie do serwisu www.bergss.pl (dalej „Serwis”). Otwieranie i przeglądanie witryny jest równoznaczne z zaakceptowaniem zasad poufności. Zbierane automatycznie informacje nie mają charakteru danych osobowych.
Firma Bergss dba o ochronę prywatności osób odwiedzających jej witrynę internetową. Firma może przekazywać zaufanym stronom trzecim statystyki zbiorcze dotyczące klientów, sprzedaży, liczby odwiedzin oraz inne informacje związane z tą witryną. Wszelkie dane przekazywane są do podmiotów trzecich po anonimizacji, która zapewnia Użytkownikowi zachowanie pełnej prywatności.
Dokładamy wszelkich starań, aby dane dotyczące osób odwiedzających Serwis pozostawały prywatne. W związku z tym prosimy o zapoznanie się z poniższym dokumentem w celu zrozumienia polityki prywatności Bergss.
Dane osobowe
...
Firma Bergss zastrzega sobie prawo do zmiany treści niniejszej polityki prywatności. Wynika to z możliwości wprowadzania zmian, modyfikacji oraz wycofywania zawartości Serwisu bez uprzedzenia Użytkowników.
