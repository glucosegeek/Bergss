...
const FAQ: React.FC = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Absolutnie nie! Zajmujemy się całym procesem wdrożenia. Nasz zespół konfiguruje AI, szkoli ją na danych Twojej firmy i integruje z istniejącymi systemami. Czas na wdrożenie jest ustanalny indywidualnie z każdym klientem, z ciągłym wsparciem i optymalizacją ze strony naszego zespołu technicznego."
    },
    {
