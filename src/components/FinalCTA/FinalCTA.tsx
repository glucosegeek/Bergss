    ...
    <section className="relative py-20 md:py-32 overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 md:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <button className="group relative w-full sm:w-auto px-8 py-4 bg-white rounded-lg text-lg font-semibold text-indigo-600 shadow-lg shadow-black/25 hover:shadow-black/40 transition-all duration-300 hover:scale-105">
